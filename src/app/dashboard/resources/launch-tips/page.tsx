        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
          {['Register your LLC', 'Order vendor samples', 'Set up Shopify store', 'Design your brand', 'Stock initial inventory', 'Launch on social media'].map((item, idx) => (
            <div key={idx} className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 flex-shrink-0" style={{ color: '#D4713B' }} />
          ...
          <div className="rounded-2xl bg-white p-8 shadow-sm" style={{ border: '1px solid #EDE5DB' }}>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl" style={{ backgroundColor: '#F5F3FF', color: '#7C3AED' }}>
                  {activeContent.icon}
                </div>
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider" style={{ color: '#7C3AED' }}>{activeContent.category}</span>
              ...
              <button
                ...
                style={{ backgroundColor: bookmarked.includes(activeContent.id) ? '#F5F3FF' : '#F9FAFB', color: bookmarked.includes(activeContent.id) ? '#7C3AED' : '#9CA3AF' }}
              >
            ...
            <div className="mt-10 pt-6" style={{ borderTop: '1px solid #EDE5DB' }}>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button className="rounded-lg px-4 py-2 text-sm font-medium text-white transition-colors" style={{ backgroundColor: '#7C3AED' }}>
                    Yes, thanks!
                  </button>
          ...
          {articles.map((article) => (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <span className="rounded-full px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider" style={{ backgroundColor: '#F5F3FF', color: '#7C3AED' }}>
                  {article.category}
                </span>
              </div>
