...
const assets: BrandAsset[] = [
  ...
  { id: '8', name: 'Brand Guidelines PDF', description: 'Complete brand book with colors, typography, logo usage rules', type: 'guideline', format: 'PDF', size: '12.3 MB', icon: <FileText className="h-5 w-5" />, color: 'text-purple-500 bg-purple-50' },
  { id: '9', name: 'Color Palette Swatches', description: 'Primary, secondary, and accent colors with HEX, RGB, CMYK values', type: 'guideline', format: 'PDF + ASE', size: '0.8 MB', icon: <Palette className="h-5 w-5" />, color: 'text-purple-500 bg-purple-50' },
  { id: '10', name: 'Typography Guide', description: 'Font pairings, sizes, and usage guidelines for your store', type: 'font', format: 'PDF + OTF', size: '3.4 MB', icon: <Type className="h-5 w-5" />, color: 'text-emerald-500 bg-emerald-50' },
