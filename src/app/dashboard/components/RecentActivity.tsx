      ...
      <CardContent>
        {orders.length === 0 ? (
          <div className="flex flex-col items-center py-8 text-center">
            ...
            <p className="text-sm text-gray-500">No orders yet. They&apos;ll appear here once your store is set up.</p>
          </div>
        ) : (
            ...
            {orders.map((order) => (
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-sm font-medium text-gray-900">{formatCents(order.subtotal_cents)}</p>
